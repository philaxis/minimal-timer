...
- [ ] Verify with Node tests, production build, actual desktop/mobile browser interactions, reload persistence and offline shell. Verify live auth/sync/push when credentials and provider configuration are available.
